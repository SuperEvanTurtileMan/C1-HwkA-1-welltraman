...
public class HotPotato {
	...
	//			   "userName".
	boolean hotPotatoHasBeenPassed = false;
	String userName;
	...
	public void passTo(String name)
	{
		if (name.equals("dropped") || name.equals("put on table"))
		{
			hotPotatoHasBeenPassed = false;
			userName = "";
		}
		else
		{
			hotPotatoHasBeenPassed = true;
			userName = name;
		}
	}
}